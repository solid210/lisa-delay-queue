...
import static org.lisa.delayqueue.base.constant.Constant.MESSAGE_BODY;
import static org.lisa.delayqueue.base.constant.Constant.ZSET_WAITING_QUEUE;
...
public class ProducerImpl implements Producer, InitializingBean {
    ...
    public static final String RESOURCE_NAME = "script/lua/push_msg_to_waiting_queue.lua";
    public static final String LUA_NAME = "push_msg_to_waiting_queue.lua";
    ...
    public <T> void send(Message<T> msg, long expectAt) {
        ...
        log.info("[开始]调用lua脚本添加延时消息。waitingQueueKey:{}, msgId:{}, score:{}, msgBodyKey:{}, msgBodyValue:{}", waitingQueueKey, msgId, score, msgBodyKey, msgBodyValue);
        Boolean result = stringRedisTemplate.execute(getRedisScript(RESOURCE_NAME, LUA_NAME, Boolean.class), Lists.newArrayList(waitingQueueKey), msgId, score, msgBodyKey, msgBodyValue);
